...
- Generated at: `2026-07-16T04:39:14Z`
- Non-regressive: `true`
...
## Compile Artifacts
- `required.core_workflow_ast`: `pass` (`.orchestrate/build/4a891e285623326b/core_workflow_ast.json`)
- `required.semantic_ir`: `pass` (`.orchestrate/build/4a891e285623326b/semantic_ir.json`)
- `required.source_map`: `pass` (`.orchestrate/build/4a891e285623326b/source_map.json`)
