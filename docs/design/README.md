...
| [workflow_lisp_prompt_calculus.md](workflow_lisp_prompt_calculus.md) | Target-2.20 prompt core: importable `defprompt`, closed doc/text/value/path slots, fully applied named fills, prompt-owned returns, and a minimum compiled-fragment identity | Accepted Q1 design; implementation plan next | No | Ordered independent specification and quality reviews accepted the corrected Q1 boundary on 2026-07-26. Q1 forbids residual fragments, prompt values, parallel call-site inputs/dependencies/returns, output-position slots, judgments, and procedure/provider substitution. Q2–Q4 retain their separate ownership. |
