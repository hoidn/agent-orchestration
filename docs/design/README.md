...
| [workflow_lisp_runtime_migration_foundation.md](workflow_lisp_runtime_migration_foundation.md) | Runtime foundation for promotion gates, command outputs, and paths | Designed/partial | No | Read before implementing parity-gate, structured command-output, or path-allocation work. |
