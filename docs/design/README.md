...
| [workflow_lisp_native_transportable_returns.md](workflow_lisp_native_transportable_returns.md) | Uniform native returns and optional typed result guidance | Partial (native returns landed; guidance designed) | Preview only | Native direct-root carriage is implemented behind the compiler-recognized v2.15 preview; typed root/field guidance and public v2.15 promotion remain pending. |
