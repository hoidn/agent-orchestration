...
**Component-plan routing:** [Executor decomposition](plans/2026-07-07-executor-decomposition.md), [lowering-fork migration](plans/2026-07-07-lowering-fork-migration.md), [typecheck-family completion](plans/2026-07-07-typecheck-family-completion.md), and [build-module split](plans/2026-07-07-build-module-split.md) are closed through their final verification gates. The accepted [runtime union-field lineage plan](plans/2026-07-09-runtime-union-field-lineage-plan.md) is the active prerequisite for [boundary-report follow-ups](plans/2026-07-08-boundary-report-followups.md) Task 5 case 5. Task 6 and the final boundary gate remain paused, and the [drain migration / G8 retirement plan](plans/2026-07-07-drain-migration-g8-retirement.md) must not begin until that lineage implementation and boundary closure are verified. The [Stage-0 activation plan](plans/2026-07-09-procedure-first-roadmap-activation-plan.md) owns activation evidence and plan-set tracking.

**Later procedure-first substrate:** [Workflow Lisp structured-result field guidance](plans/2026-07-09-workflow-lisp-structured-result-field-guidance-plan.md) is Pending. Stage 4 must define and accept its author-facing frontend contract; the revised plan then executes first in Stage 5 before the procedure-first pilot. It does not change the current Stage 1-3 selection.
