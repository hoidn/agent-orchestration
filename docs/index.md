...
**Component-plan routing:** [Executor decomposition](plans/2026-07-07-executor-decomposition.md), [lowering-fork migration](plans/2026-07-07-lowering-fork-migration.md), [typecheck-family completion](plans/2026-07-07-typecheck-family-completion.md), and [build-module split](plans/2026-07-07-build-module-split.md) are closed through their final verification gates. The [runtime union-field lineage plan](plans/2026-07-09-runtime-union-field-lineage-plan.md) and [boundary-report follow-ups](plans/2026-07-08-boundary-report-followups.md) are also complete. [Drain migration / G8 retirement](plans/2026-07-07-drain-migration-g8-retirement.md) Phase 1, Phase 2 Tasks 2.1–2.3, Phase 3 Tasks 3.1–3.4, and Phase 4 Task 4.1 are complete; Gates P3 and P4 are independently reviewed and satisfied, and Task 4.1 is complete and independently reviewed with SPEC PASS and CODE QUALITY PASS. The family-specific certification bundle is retired and no longer a live compile/evidence lane. The bounded [YAML-retirement](plans/2026-07-07-yaml-retirement-program.md) Task-5 family-1 promotion handoff is recorded through registration, strict parity, the `.orc` primary flip, and fresh end-to-end evidence without archive. **The current selector is drain Phase 4 Task 4.2: strip the G8 serializer. Task 4.2 has not started, and no Task-4.2 deletion has begun. Stage 5 typed result guidance and Stage 6 YAML archive remain later work.** The [Stage-0 activation plan](plans/2026-07-09-procedure-first-roadmap-activation-plan.md) owns activation evidence and plan-set tracking.
