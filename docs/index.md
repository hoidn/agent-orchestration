...
**Description:** Current executable selector for post-hardening procedure-first family migrations. Tasks 1–6 are complete on retained-boundary evidence; Task 7 Step 1 is the current sub-selector.
...
**Use this when:** Reviewing why Task 6 performed no source/history migration or why Task 7 Step 1 is current.
