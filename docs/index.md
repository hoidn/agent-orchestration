...
**Component-plan routing:** [Executor decomposition](plans/2026-07-07-executor-decomposition.md), [lowering-fork migration](plans/2026-07-07-lowering-fork-migration.md), [typecheck-family completion](plans/2026-07-07-typecheck-family-completion.md), and [build-module split](plans/2026-07-07-build-module-split.md) are closed through their final verification gates. The [runtime union-field lineage plan](plans/2026-07-09-runtime-union-field-lineage-plan.md) and [boundary-report follow-ups](plans/2026-07-08-boundary-report-followups.md) are also complete. The next active work is [drain migration / G8 retirement](plans/2026-07-07-drain-migration-g8-retirement.md) Phase 1 Task 1.1, under the semantic-migration freeze. The [Stage-0 activation plan](plans/2026-07-09-procedure-first-roadmap-activation-plan.md) owns activation evidence and plan-set tracking.

**Later procedure-first substrate:** The [accepted native-return and typed-guidance design](design/workflow_lisp_native_transportable_returns.md) is scheduled in two reviewed Stage-5 waves: [native transportable returns](plans/2026-07-10-workflow-lisp-native-transportable-returns-plan.md), then [typed result guidance](plans/2026-07-10-workflow-lisp-typed-result-guidance-plan.md), then the procedure-first pilot. Both implementation plans remain gated by S3/S4 and do not change the current Stage 1-3 selection. The older [field-guidance proposal](plans/2026-07-09-workflow-lisp-structured-result-field-guidance-plan.md) is superseded.
