...
**Component-plan routing:** [Executor decomposition](plans/2026-07-07-executor-decomposition.md), [lowering-fork migration](plans/2026-07-07-lowering-fork-migration.md), [typecheck-family completion](plans/2026-07-07-typecheck-family-completion.md), and [build-module split](plans/2026-07-07-build-module-split.md) are closed through their final verification gates. The [runtime union-field lineage plan](plans/2026-07-09-runtime-union-field-lineage-plan.md) and [boundary-report follow-ups](plans/2026-07-08-boundary-report-followups.md) are also complete. [Drain migration / G8 retirement](plans/2026-07-07-drain-migration-g8-retirement.md) Phase 1, Phase 2 Tasks 2.1–2.3, Phase 3 Tasks 3.1–3.4, and Phase 4 Tasks 4.1–4.2 are complete. Gates P3 and P4 are independently reviewed and satisfied. Task 4.1 is complete and independently reviewed with SPEC PASS and CODE QUALITY PASS. Task 4.2 is complete and independently reviewed with SPEC PASS and CODE QUALITY PASS. The family-specific certification bundle and temporary G8 build serializer are retired. The bounded [YAML-retirement](plans/2026-07-07-yaml-retirement-program.md) Task-5 family-1 promotion handoff is recorded through registration, strict parity, the `.orc` primary flip, and fresh end-to-end evidence without archive. **The current selector is drain Phase 4 Task 4.3: final verification and closeout. Task 4.3 has not started. Final verification and final closeout have not begun. Stage 5 typed result guidance and Stage 6 YAML archive remain later work.** The [Stage-0 activation plan](plans/2026-07-09-procedure-first-roadmap-activation-plan.md) owns activation evidence and plan-set tracking.

**Later procedure-first substrate:** The [accepted native-return and typed-guidance design](design/workflow_lisp_native_transportable_returns.md) is scheduled in two reviewed Stage-5 waves. **Amendment (2026-07-10):** wave 1, [native transportable returns](plans/2026-07-10-workflow-lisp-native-transportable-returns-plan.md), executed ahead of Gates S3/S4 (the former drain Phase 1 Task 1.5 blocker) and is now landed compiler-internally; DSL v2.15 stays an unreleased private preview until wave 2 promotes it. Gates P2–P4 are satisfied, but the live sequence still executes drain Phase 4 and the intervening roadmap stage first. [Typed result guidance](plans/2026-07-10-workflow-lisp-typed-result-guidance-plan.md) remains the later Stage-5/post-drain wave, followed by the procedure-first pilot. The older [field-guidance proposal](plans/2026-07-09-workflow-lisp-structured-result-field-guidance-plan.md) is superseded.
