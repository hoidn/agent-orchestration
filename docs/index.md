...
**Description:** Active parallel substrate track. M0 green-baseline closure is selected and in progress under its reviewed component plan; later phases retain their own entry gates.
**Keywords:** workflow-lisp, substrate, maintenance, persistence, roadmap, m0, m1
**Use this when:** Selecting or auditing substrate work beside the Q/L roadmap. M1 remains ineligible until the M0 green gate closes and then requires its own reviewed component plan before selection.

### [M0 Green Baseline Implementation Plan](plans/2026-07-29-m0-green-baseline-component-plan.md)
**Description:** Reviewed five-task plan for the selected and in progress M0 green-baseline closure: preserve landed fixes, keep entry-bootstrap eligibility fail-closed, add its replacement-rule pointer, repair the two metadata drifts, and prove a fresh green baseline.
**Keywords:** workflow-lisp, substrate, m0, green-baseline, refusal-diagnostic, routing
**Use this when:** Executing or auditing M0. M1 remains ineligible until the M0 green gate closes and requires its own reviewed component plan before selection; this plan neither begins nor prepares M1.
...
**Current substrate selection:** M0 is selected and in progress under the reviewed [M0 Green Baseline Implementation Plan](plans/2026-07-29-m0-green-baseline-component-plan.md). M1 remains ineligible and unselected until M0's green gate closes, and it then requires its own reviewed component plan before selection.
