...
**Description:** Active parallel substrate track. M0 is complete at `f15b888d` under its reviewed component plan and external exact-commit closure; M1's exact Task 0 candidate is routed through its own ordered plan reviews and reviewed selection commit.
**Keywords:** workflow-lisp, substrate, maintenance, persistence, roadmap, m0, m1
**Use this when:** Selecting or auditing substrate work beside the Q/L roadmap. M0 is complete. M1 is selected only by external specification-then-quality approval and commit of the exact Task 0 candidate in its component plan; no Q5 or L-series gate is reopened.
...
**Use this when:** Auditing completed M0. Use the M1 component plan for current substrate execution.

### [M1 Estate Shrink Implementation Plan](plans/2026-07-29-m1-estate-shrink-component-plan.md)
**Description:** Tasks 0–9 for deleting served-purpose retirement, migration, queue, and gate machinery; narrowing bounded compatibility shims; excluding demo support from wheels; and reversibly archiving the closed legacy run estate.
**Keywords:** workflow-lisp, substrate, m1, estate-shrink, retirement, run-archive
**Use this when:** Selecting or executing M1. The exact Task 0 candidate becomes selected only after one external specification review and one distinct quality review approve identical bytes and the reviewed candidate is committed. Route readiness, `frontend_kind` provenance, report/dashboard state views, six current-format nonterminal runs, security surfaces, and historical YAML-retirement evidence stay outside deletion.
...
**Current substrate selection:** M0 is complete at commit `f15b888d0c4862f7e229b990255d5f34c7392591`, tree `8a75f24fde68b657d2f84b28aa8b4d34df5089cf`, under the reviewed [M0 Green Baseline Implementation Plan](plans/2026-07-29-m0-green-baseline-component-plan.md) and external closure-record SHA-256 `88f35cdd872ba9e5a9602d3e756ee81e2911c2384e74c6fa2388cdb907e2ba0e`; its postcommit control passed 418 tests. M1 is routed through the exact Task 0 candidate in the [M1 Estate Shrink Implementation Plan](plans/2026-07-29-m1-estate-shrink-component-plan.md) and becomes selected only when external specification-then-quality reviews approve identical bytes and that reviewed candidate is committed. No Q5 or L-series gate is reopened.
