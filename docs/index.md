...
**Use this when:** Selecting or sequencing current post-Stage-8 work. Q4 remains gated on a bound concrete consumer. In L, L3 completed over MR-4 under its reviewed plan; select L4 only through its separate design review and editor-evidence gate. Do not select E0, the parked evolution roadmap, shelved parsimony candidates, or P1–P5 from this route.
...
**Use this when:** Configuring a generic LSP client or interpreting current dirty, pending, failed, invalidated, stale, initialization-failure, or no-watcher save behavior. L1, L2, L3, and L5 are shipped here; L4 remains governed by its later active-roadmap design gate.
