...
**Use this when:** Selecting or auditing substrate work beside the completed Q/L roadmap. Phase ML and M2 component (a) are historical complete. M3a Task 1 is selected under its reviewed activation component plan; ordinary CLI-created roots and fresh call frames remain historical-profile until their implementation tasks land. Component (b) is evidence-gated and unselected, and MC, MR, M3b, M3c, and M4 remain unselected. ML-3/provider-isolation remains deferred; no Q5 or L-series gate is reopened or re-reviewed.
...
**Use this when:** Auditing the explicit-profile M2 feasibility mechanism or planning the separate M3a activation. The feasibility implementation landed through `cf0490d1` with correction `ce02cd17`; the final broad gate and ordered closure reviews passed. It does not authorize ordinary CLI/fresh-frame activation, memo-first effect reuse, recurrent/loop replay, or M3a implementation.
...
**Description:** Reviewed and selected M3a plan for activating the accepted replay profile at typed public new-root, force-restart, and fresh non-iterative Workflow Lisp call-frame creation points.
**Keywords:** workflow-lisp, persistence, replay, activation, m3a, component-plan
**Use this when:** Executing or auditing the M3a activation boundary. Task 1 is selected after ordered plan reviews approved corrected proposal `6e06b4c0`; existing roots/frames, generic initialization, non-Workflow-Lisp callees, and iteration-owned frames remain historical-profile.
