...
**Use this when:** Checking the E-series shape, gates, and sequencing prerequisites, or tracing the historical proposal. E0 is complete at `fe7d6f9b`, tree `c20f6fd9`, with `PASS_E0` after ordered `E0_FINAL_SPEC_APPROVED` then `E0_FINAL_QUALITY_APPROVED`; its fresh postcommit control passed 115 tests. The canonical source is copy-safe only for the bounded one-call direct-task shape. E1-E3 are owner-selected as of 2026-07-31: the E1 component plan is accepted for execution at target 2.24 under the [reviewed plan](plans/2026-07-31-workflow-lisp-e1-run-ref-component-plan.md) and [plan review](../artifacts/review/e1-run-ref-plan-review.md), with Task 1 active; E2 is selected pending the canonical E1 exit gate at target 2.25; E3 is selected pending the canonical E2 exit gate and review of the first fixed study. C1-C3 remain Designed and unselected. E4P is exclusively absorbed by successor Stage Q3.
...
**Use this when:** Executing E1 Tasks 1–9 or auditing its preacceptance compiler-hermeticity proof. The plan was accepted at `0c392ac9`, tree `3a55ac5f`, after ordered `E1_PLAN_SPEC_APPROVED` then `E1_PLAN_QUALITY_APPROVED`; see the [plan review](../artifacts/review/e1-run-ref-plan-review.md). Task 1 is active. Target 2.24 and `run-ref` remain unimplemented until their owning tasks land, and E2/E3 remain predecessor-gated.
