...
**Description:** Accepted strict-default compatibility contract with a bounded, evidence-only internal identity-retirement class. Its generic prerequisites are implemented and gated; the tracked-plan pilot is not complete.
...
**Description:** Active first reviewed-internal-identity-retirement pilot. Task 1A's immutable pre-edit evidence is committed at `63e03330`; Task 2's one-phase migration and compile-only characterization landed and passed two-stage review at `e6a85cb7`. Task 3 has one protected completed clean run plus one failed interrupted run. The first recovery authorization was consumed and the attempt failed at fresh-child resume propagation. The generic fix landed and passed ordered reviews at `1cba48c8`; retained evidence remains unpublished. The exact second-recovery form remains pending and awaits ordered harness reviews, the harness commit, mechanical population of its exact commit/tree and review bindings, and genuine owner confirmation. No second attempt has occurred, and runtime evidence remains incomplete.
**Keywords:** procedure-first, pilot, tracked-plan, retirement, attestation, quiescence
**Use this when:** Executing or reviewing the current Stage-5 pilot gate and its exact source-edit boundary.
...
**Description:** Planned post-pilot, pre-migration-wave design and planning work for generic checksum-compatible resume projection-integrity auditing; it does not implement runtime hardening.
**Keywords:** resume, projection, integrity, procedure-first, design-plan, hardening
**Use this when:** Preparing the design/specification and later implementation plan that must complete before migration waves begin.
...
**Component-plan routing:** [Executor decomposition](plans/2026-07-07-executor-decomposition.md), [lowering-fork migration](plans/2026-07-07-lowering-fork-migration.md), [typecheck-family completion](plans/2026-07-07-typecheck-family-completion.md), and [build-module split](plans/2026-07-07-build-module-split.md) are closed through their final verification gates. The [runtime union-field lineage plan](plans/2026-07-09-runtime-union-field-lineage-plan.md), [boundary-report follow-ups](plans/2026-07-08-boundary-report-followups.md), and [Drain migration / G8 retirement](plans/2026-07-07-drain-migration-g8-retirement.md) are complete. Gates S3 and S4 are satisfied; Stage 4 closed with independent holistic specification and quality passes. Stage 5 native returns, typed result guidance, the [resolved-effect substrate](plans/2026-07-13-procedure-first-substrate-gaps-plan.md), and the [identity-compatibility prerequisites](plans/2026-07-13-procedure-migration-identity-compatibility-plan.md) are complete and independently gated; the prerequisite-to-pilot handoff is `f5adcb79`, and DSL v2.15 is public. **The current selector is the [tracked-plan pilot](plans/2026-07-13-procedure-first-pilot-plan.md). Task 1A's immutable pre-edit evidence is committed at `63e03330`; Task 2's one-phase source migration, provisional compile-only characterization, and two-stage review are complete at `e6a85cb7`.** The frozen baseline remains unchanged. Task 3 has one protected completed clean run plus one failed interrupted run. The first recovery authorization was consumed and the attempt failed at fresh-child resume propagation. The generic fix landed and passed ordered reviews at `1cba48c8`; retained evidence remains unpublished. The exact second-recovery form remains pending and awaits ordered harness reviews, the harness commit, mechanical population of its exact commit/tree and review bindings, and genuine owner confirmation. No second attempt has occurred, and runtime evidence remains incomplete. The exact-two-run protocol still requires a separately authorized same-ID interrupted-run recovery, retirement-record validation and independent review, explicit owner hold release, and the deferred family/focused/broad gates in Task 5. All later post-pilot stages remain paused behind completion of this selected pilot and its required hardening/migration sequencing. The deletion-first YAML Task 6 estate sweep is the sole scheduling exception: it may run as an independent tranche around pilot quiescence, but it is not selected, has not started, is not full Stage 6, and does not reorder the paused top-level stages. Do not advance to the [resume projection-integrity hardening design and planning plan](plans/2026-07-13-resume-projection-integrity-hardening-design-plan.md) until the pilot completes. After that plan and its resulting implementation plan complete, begin the [reviewed migration waves](plans/2026-07-13-procedure-first-migration-waves-plan.md). Later routing remains [Stage 6 YAML retirement](plans/2026-07-07-yaml-retirement-program.md), [Stage 7 provider live binding](design/workflow_lisp_provider_live_binding.md), and [Stage 8 language server](design/workflow_lisp_language_server.md), in that order. The [Stage-0 activation plan](plans/2026-07-09-procedure-first-roadmap-activation-plan.md) owns activation evidence and plan-set tracking.

**Current procedure-first substrate:** The [accepted native-return and typed-guidance design](design/workflow_lisp_native_transportable_returns.md) is implemented through both reviewed Stage-5 return waves: [native transportable returns](plans/2026-07-10-workflow-lisp-native-transportable-returns-plan.md) and [typed result guidance](plans/2026-07-10-workflow-lisp-typed-result-guidance-plan.md). DSL v2.15 is supported by ordinary loaders. The older [field-guidance proposal](plans/2026-07-09-workflow-lisp-structured-result-field-guidance-plan.md) is superseded. The [resolved-effect substrate](plans/2026-07-13-procedure-first-substrate-gaps-plan.md), generic [identity-compatibility prerequisites](plans/2026-07-13-procedure-migration-identity-compatibility-plan.md), and generic match-scoped scanner/record support are implemented and gated. The [architect decision record](plans/2026-07-14-tracked-plan-pilot-identity-retirement-decision-request.md) selected Path A; owner-adopted records and the complete Task 1A evidence gate are committed at `63e03330`. Pilot Task 2 landed at `e6a85cb7`; Task 3 has one protected completed clean run plus one failed interrupted run. The first recovery authorization was consumed and the attempt failed at fresh-child resume propagation. The generic fix landed and passed ordered reviews at `1cba48c8`; retained evidence remains unpublished. The exact second-recovery form remains pending and awaits ordered harness reviews, the harness commit, mechanical population of its exact commit/tree and review bindings, and genuine owner confirmation. No second attempt has occurred, and no second mutation is authorized. Runtime evidence remains incomplete.
