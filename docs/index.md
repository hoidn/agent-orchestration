...
**Use this when:** Selecting or sequencing current post-Stage-8 work. Q4 remains gated on a bound concrete consumer. In L, L3 completed over MR-4 under its reviewed plan; L4's separate implementation-plan gate is next after its accepted design. Do not select E0, the parked evolution roadmap, shelved parsimony candidates, or P1–P5 from this route.
...
`L4_DESIGN_SPEC_APPROVED` then `L4_DESIGN_QUALITY_APPROVED`, but shipped
behavior remains unchanged until a separate implementation plan,
