...
**Description:** Active first reviewed-internal-identity-retirement pilot. Task 1A's corrected scans, owner records, isolation, quiescence, incident recovery, rechecks, and two-stage reviews passed, and its immutable pre-edit evidence package is committed at `63e03330`; fresh post-commit hold probes pass. The pilot source and baseline remain unchanged. Task 2 is selectable but remains `not_selected` and not started.
