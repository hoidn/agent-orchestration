...
**Description:** Current executable selector for post-hardening procedure-first family migrations. Tasks 1–4 are complete; Task 5's reviewed finalizer-projection subfamily is retained, and blocked recovery/finalization is the current sub-selector.
...
**Use this when:** Reviewing the finalizer-projection retention evidence or the handoff to the current blocked recovery/finalization subfamily.

### [Procedure-First Reuse Inventory](plans/2026-07-13-procedure-first-reuse-inventory.md)
**Description:** Reviewed current inventory of 95 active internal authored call sites—18 procedure candidates, 14 effect adapters, and 63 legacy-retire sites—plus eight separately recorded public entries and one append-only migrated-history row, with machine-readable provenance in the adjacent JSON file.
