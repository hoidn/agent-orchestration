...
**Use this when:** Selecting or auditing substrate work beside the Q/L roadmap. Phase ML is historical complete; this closure does not auto-select MC, MR, M2, M3, or M4. ML-3/provider-isolation and every security surface remain deferred; no Q5 or L-series gate is reopened or re-reviewed.
