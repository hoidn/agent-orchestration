...
**Description:** Current executable selector for post-hardening procedure-first family migrations. Task 1's inventory/prerequisite rebaseline is complete; Task 2's small-example family is the current sub-selector.
