...
**Use this when:** Checking the E-series shape, gates, and sequencing prerequisites, or tracing the historical proposal. E1-E3 are owner-selected. E0 is complete at `fe7d6f9b`, tree `c20f6fd9`, with `PASS_E0`. E1 is complete at `577715f1`, tree `ef7eacbd`, with `PASS_E1` after ordered `E1_FINAL_SPEC_APPROVED` then `E1_FINAL_QUALITY_APPROVED`; see the [reviewed target-2.24 plan](plans/2026-07-31-workflow-lisp-e1-run-ref-component-plan.md), [plan review](../artifacts/review/e1-run-ref-plan-review.md), and [final review](../artifacts/review/e1-run-ref-final-review.md). The [target-2.25 E2 component plan](plans/2026-08-01-workflow-lisp-e2-trial-component-plan.md) is accepted at `c6046d38`, tree `40c533fc`, after ordered `E2_PLAN_SPEC_APPROVED` then `E2_PLAN_QUALITY_APPROVED`; see the [plan review](../artifacts/review/e2-trial-plan-review.md). Tasks 0–9 are complete: Tasks 1–8 landed through `ebf8a1a9`, tree `7f3a3b22`; Task 9 implemented the public executor, SDK, and CLI through the ordinary compiler/runtime path across exact range `167b4a5d..3560b62edc623ebe15ca3c2b5c0e66eeb2f004aa`, final tree `f214f7627906e84782ad8ce04dc7c3bae51b276f`, cumulative diff SHA-256 `ebabf1870f8212e950f911a0487a06bfcc116c41a1aa0a411e435b809a0b8745`, and commits/trees `c69f05c9`/`d2fe944a`, `587ad8af`/`f944092e`, `e510844f`/`7f90defa`, `f8d7527e`/`04096b96`, `15609efc`/`1b253369`, and `3560b62e`/`f214f762`, after ordered `E2_TASK9_SPEC_APPROVED` then `E2_TASK9_QUALITY_APPROVED`. Its overlapping selectors passed 26 SDK, 487 integration, 55 observability, 208 final-slice, and 492 expanded combined tests. Task 10 is selected. E2 is not generally copy-safe and no `PASS_E2` has been recorded, so E3 remains owner-selected but not yet eligible pending `PASS_E2`, review of the first fixed study, and a separate component plan. C1-C3 remain Designed and unselected. E4P is exclusively absorbed by successor Stage Q3.
...
**Use this when:** Executing or auditing E2 under the exact reviewed candidate at `c6046d38`, tree `40c533fc`, after ordered `E2_PLAN_SPEC_APPROVED` then `E2_PLAN_QUALITY_APPROVED`; see the [plan review](../artifacts/review/e2-trial-plan-review.md). Tasks 0–9 are complete: Tasks 1–8 landed through Task 8 at `ebf8a1a9`, tree `7f3a3b22`; Task 9 spans `167b4a5d..3560b62edc623ebe15ca3c2b5c0e66eeb2f004aa`, final tree `f214f7627906e84782ad8ce04dc7c3bae51b276f`, cumulative diff SHA-256 `ebabf1870f8212e950f911a0487a06bfcc116c41a1aa0a411e435b809a0b8745`, and commits/trees `c69f05c9`/`d2fe944a`, `587ad8af`/`f944092e`, `e510844f`/`7f90defa`, `f8d7527e`/`04096b96`, `15609efc`/`1b253369`, and `3560b62e`/`f214f762`, after ordered `E2_TASK9_SPEC_APPROVED` then `E2_TASK9_QUALITY_APPROVED`. Its overlapping selectors passed 26 SDK, 487 integration, 55 observability, 208 final-slice, and 492 expanded combined tests. The public executor, SDK, and CLI now use the ordinary compiler/runtime path. Task 10 is selected; E2 remains not generally copy-safe and has no `PASS_E2`, and E3 remains owner-selected but ineligible pending `PASS_E2`, review of the first fixed study, and a separate component plan. The historical registry/handle E2 proposal, E2O, C1-C3, and security/isolation work are not selected by this plan.
