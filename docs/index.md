...
**Description:** Current executable selector for post-hardening procedure-first family migrations. Tasks 1–3 are complete; Task 4 Step 1, auditing the ten YAML effect-adapter groups, is current.
...
**Description:** Reviewed current inventory of 95 active internal authored call sites—22 procedure candidates, 35 effect adapters, and 38 legacy-retire sites—plus eight separately recorded public entries and one append-only migrated-history row, with machine-readable provenance in the adjacent JSON file.
