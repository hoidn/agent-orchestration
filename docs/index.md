...
**Use this when:** Reviewing or amending the `.orc` editor-tooling direction for the eligible final Stage 8. The current design still requires independent review and the recorded feasibility/seam corrections before implementation planning.
