...
**Use this when:** Selecting or sequencing current post-Stage-8 work. [Q3 implementation](plans/2026-07-27-workflow-lisp-prompt-identity-diagnostics-implementation-plan.md) and the L3 per-source entry-selection design gate are next in their independent series. L3 additionally requires proven compile-path reentrancy through MR-4 or an equivalent accepted fixture. Q3 remains unimplemented and Q4 remains blocked; do not infer an accepted L3 design. Do not select E0, the parked evolution roadmap, shelved parsimony candidates, or P1–P5 from this route.
