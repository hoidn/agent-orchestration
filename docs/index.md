...
**Use this when:** Executing or auditing E2 under the exact reviewed candidate at `c6046d38`, tree `40c533fc`, after ordered `E2_PLAN_SPEC_APPROVED` then `E2_PLAN_QUALITY_APPROVED`; see the [plan review](../artifacts/review/e2-trial-plan-review.md). Tasks 1–8 are complete at `456acc7a`, `6b431087`, `43ae8d5c`, `ba430ed2`, `a7a8a083`, `5d28619d` (tree `44eb381b`), `41e64d14` (tree `fb6082d9`), and Task 8 at `ebf8a1a9`, tree `7f3a3b22`, after ordered `E2_TASK8_SPEC_APPROVED` then `E2_TASK8_QUALITY_APPROVED`. The E2 evaluator/verdict producer now exists, while the public executor, SDK, and CLI remain absent until Task 9 closes; Task 9 is selected. No `PASS_E2` has been recorded, and E3 is not yet eligible. The historical registry/handle E2 proposal, E2O, C1-C3, and security/isolation work are not selected by this plan.
