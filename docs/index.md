...
**Component-plan routing:** [Executor decomposition](plans/2026-07-07-executor-decomposition.md), [lowering-fork migration](plans/2026-07-07-lowering-fork-migration.md), [typecheck-family completion](plans/2026-07-07-typecheck-family-completion.md), and [build-module split](plans/2026-07-07-build-module-split.md) are closed through their final verification gates. [Boundary-report follow-ups](plans/2026-07-08-boundary-report-followups.md) is paused at the Task 5 case 5 production design gate: cases 2 and 3 landed, but runtime contract violations cannot yet be source-mapped to authored `defunion` variant fields. Task 6 and the final gate remain paused, and the [drain migration / G8 retirement plan](plans/2026-07-07-drain-migration-g8-retirement.md) must not begin until that lineage gap is designed, implemented, and verified. The [Stage-0 activation plan](plans/2026-07-09-procedure-first-roadmap-activation-plan.md) owns activation evidence and plan-set tracking.
