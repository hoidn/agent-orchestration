...
**Use this when:** Selecting or sequencing current post-Stage-8 work. Q4 remains gated on a bound concrete consumer. In L, L3 completed over MR-4 under its reviewed plan; L4 Task 4 broad comparison and final closure are next under its reviewed implementation plan. Do not select E0, the parked evolution roadmap, shelved parsimony candidates, or P1–P5 from this route.
...
repository-real Neovim acceptance passes. Task 4 broad comparison and final
closure are next.
...
reviews, and acceptance gates. Tasks 1 and 2 are committed and the
repository-real Neovim acceptance passes; Task 4 broad comparison and final
closure are next after the Task 3 reviewed documentation commit.
