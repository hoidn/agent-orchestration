...
**Use this when:** Checking the E-series shape, gates, and sequencing prerequisites, or tracing the historical proposal. The accepted designs remain non-copy-safe while E0 is incomplete. ML closure and the lean-pilot owner-decision handoff are complete. The reviewed component plan selects E0 only; Task 1's canonical source/compile contract landed at `b71bf62a`, Task 2 is in progress under a pending feasibility correction, and E0 is not complete. E1-E3 and C1-C3 remain unselected. E4P is exclusively absorbed by successor Stage Q3.
