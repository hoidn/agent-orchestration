...
**Description:** Active parallel substrate track. M0 is historical complete at `f15b888d`. M1 is the current selected tranche and an implemented closure candidate through Task 9's pre-review controls; final reviews, closure commit, and postcommit control remain. ML is eligible but unselected pending its own ML-0 specification amendment and component plan.
**Keywords:** workflow-lisp, substrate, maintenance, persistence, roadmap, m0, m1
**Use this when:** Selecting or auditing substrate work beside the Q/L roadmap. Audit M0 as historical closure and M1 from its exact Task 9 closure candidate. Do not treat listing ML, MC, or MR as selection; ML still needs its own reviewed gate and plan. No Q5 or L-series gate is reopened.
...
**Description:** Implemented closure candidate through Task 8. Tasks 0–7 delete served-purpose retirement, migration, queue, and gate machinery, narrow bounded compatibility shims, and exclude demo support from wheels; Task 8 reversibly archived 4,168 closed/legacy run directories while retaining six current `.orc` runs.
**Keywords:** workflow-lisp, substrate, m1, estate-shrink, retirement, run-archive
**Use this when:** Closing the current selected M1 tranche. The exact deletion, gate, archive, and preserved-evidence bindings plus the pre-review controls are complete; final reviews, closure commit, and postcommit control remain. Route readiness, `frontend_kind` provenance, report/dashboard state views, six current-format nonterminal runs, security surfaces, and frozen YAML-retirement evidence remain outside deletion.
...
**Current substrate selection:** M0 is historical complete at commit `f15b888d0c4862f7e229b990255d5f34c7392591`, tree `8a75f24fde68b657d2f84b28aa8b4d34df5089cf`, under the reviewed [M0 Green Baseline Implementation Plan](plans/2026-07-29-m0-green-baseline-component-plan.md) and external closure-record SHA-256 `88f35cdd872ba9e5a9602d3e756ee81e2911c2384e74c6fa2388cdb907e2ba0e`; its postcommit control passed 418 tests. M1 is the current selected tranche and an implemented closure candidate through Task 9's pre-review controls under the [M1 Estate Shrink Implementation Plan](plans/2026-07-29-m1-estate-shrink-component-plan.md); ordered final reviews, the reviewed closure commit, and postcommit control remain. ML is eligible but unselected pending its own ML-0 specification amendment and component plan. Listing ML, MC, or MR is not a selection act. No Q5 or L-series gate is reopened.
