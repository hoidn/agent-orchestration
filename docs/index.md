...
**Description:** Current executable selector for post-hardening procedure-first family migrations. Tasks 1–4 are complete; Task 4's three independently approved YAML audit groups landed at `c9687539`, `26d9ecd0`, and `848ceb52`, and Task 5 Step 1 is current.
...
**Description:** Reviewed current inventory of 95 active internal authored call sites—22 procedure candidates, 10 effect adapters, and 63 legacy-retire sites—plus eight separately recorded public entries and one append-only migrated-history row, with machine-readable provenance in the adjacent JSON file.
