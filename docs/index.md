...
**Keywords:** workflow-lisp, substrate, maintenance, persistence, roadmap, m0, m1, ml, mc, common-helpers, at-least-once
...
**Use this when:** Executing or auditing E2 under the exact reviewed candidate at `c6046d38`, tree `40c533fc`, after ordered `E2_PLAN_SPEC_APPROVED` then `E2_PLAN_QUALITY_APPROVED`; see the [plan review](../artifacts/review/e2-trial-plan-review.md). Tasks 1–3 are complete at `456acc7a`, `6b431087`, and `43ae8d5c`; Task 4 typed `trial` syntax and generated contracts is selected, but no production E2 trial behavior exists yet. The historical registry/handle E2 proposal, E2O, C1-C3, and security/isolation work are not selected by this plan.
