...
**Description:** Active parallel substrate track. M0 is an implemented closure candidate under its reviewed component plan; the focused and authoritative bare gates are green, while final ordered reviews, the exact-byte commit, and the post-commit control remain.
**Keywords:** workflow-lisp, substrate, maintenance, persistence, roadmap, m0, m1
**Use this when:** Selecting or auditing substrate work beside the Q/L roadmap. M0 is not complete. M1 remains ineligible and unselected until the exact reviewed M0 candidate is committed and its post-commit control passes; M1 then requires its own reviewed component plan before selection.

### [M0 Green Baseline Implementation Plan](plans/2026-07-29-m0-green-baseline-component-plan.md)
**Description:** Reviewed five-task plan with an implemented closure candidate: landed fixes are preserved, entry-bootstrap eligibility remains fail-closed with its replacement-rule pointer, both metadata drifts are repaired, the exact focused gate passed 740 tests, and the authoritative bare gate passed 12,227 tests with 28 skipped. The xdist control remains disclosed as 3 failed, 12,224 passed, and 28 skipped; it is not recorded as a pass. Final ordered reviews, the exact-byte commit, and the post-commit control remain.
**Keywords:** workflow-lisp, substrate, m0, green-baseline, refusal-diagnostic, routing
**Use this when:** Executing or auditing M0. M0 is not complete. M1 remains ineligible and unselected until the exact reviewed M0 candidate is committed and its post-commit control passes, and then requires its own reviewed component plan before selection; this plan neither begins nor prepares M1.
...
**Current substrate selection:** M0 is an implemented closure candidate under the reviewed [M0 Green Baseline Implementation Plan](plans/2026-07-29-m0-green-baseline-component-plan.md). Its focused and authoritative bare gates are green; final ordered reviews, the exact-byte commit, and the post-commit control remain. M0 is not complete. M1 remains ineligible and unselected until the exact reviewed M0 candidate is committed and its post-commit control passes, and it then requires its own reviewed component plan before selection.
