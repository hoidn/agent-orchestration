...
**Description:** Active post-Stage-8 selector with two bounded series: Q0, Q1, and Q2 are complete, the Q3 design is accepted, and its implementation-plan gate is next. In the parallel L-series, L0 reliability/actionability, L1 authored symbols/signatures, and L2 recovery-safe static completion are complete; the L3 per-source entry-selection design gate is next, with L4 still sequenced and P1–P5 unselected.
...
**Use this when:** Selecting or sequencing current post-Stage-8 work. The Q3 implementation-plan gate and L3 per-source entry-selection design gate are next in their independent series. L3 additionally requires proven compile-path reentrancy through MR-4 or an equivalent accepted fixture. Q3 remains unimplemented; do not infer an accepted L3 design. Do not select E0, the parked evolution roadmap, shelved parsimony candidates, or P1–P5 from this route.
...
Q-series selection starts at Q3's reviewed implementation-plan gate.
...
**Use this when:** Drafting or reviewing the Q3 implementation plan. The Q3
design is accepted after ordered design reviews, its implementation-plan gate
is next, and Q3 remains unimplemented; acceptance does not unblock Q4.
