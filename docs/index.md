...
**Use this when:** Auditing the completed 2026-07-07 program or tracing its prerequisite history. For sequencing, use the [Procedure-First Roadmap Execution Sequence](plans/2026-07-09-procedure-first-roadmap-execution-sequence.md); Stage 6 is complete and Stage 7 awaits an owner-scheduled design review. Do not restart Phase 1.
