...
**Description:** Accepted strict-default compatibility contract with a bounded, evidence-only internal identity-retirement class; acceptance does not claim its generic prerequisites or pilot are implemented.
...
**Description:** Current implementation plan for generic lowering-identity, inline checkpoint/provenance, retirement-evidence, and checksum-rejection prerequisites before the paused tracked-plan pilot may resume.
**Keywords:** procedure-first, prerequisites, lowering, checkpoint, provenance, checksum
**Use this when:** Executing or reviewing the current Stage-5 prerequisite gate.
...
**Component-plan routing:** [Executor decomposition](plans/2026-07-07-executor-decomposition.md), [lowering-fork migration](plans/2026-07-07-lowering-fork-migration.md), [typecheck-family completion](plans/2026-07-07-typecheck-family-completion.md), and [build-module split](plans/2026-07-07-build-module-split.md) are closed through their final verification gates. The [runtime union-field lineage plan](plans/2026-07-09-runtime-union-field-lineage-plan.md), [boundary-report follow-ups](plans/2026-07-08-boundary-report-followups.md), and [Drain migration / G8 retirement](plans/2026-07-07-drain-migration-g8-retirement.md) are complete. Gates S3 and S4 are satisfied; Stage 4 closed with independent holistic specification and quality passes. Stage 5 native returns, typed result guidance, and the [resolved-effect substrate](plans/2026-07-13-procedure-first-substrate-gaps-plan.md) are complete and independently gated, and DSL v2.15 is public. **The current selector is the [procedure-migration identity compatibility prerequisites plan](plans/2026-07-13-procedure-migration-identity-compatibility-plan.md).** The [tracked-plan pilot](plans/2026-07-13-procedure-first-pilot-plan.md) is paused until that prerequisite gate passes. Then execute the [resume projection-integrity hardening design and planning plan](plans/2026-07-13-resume-projection-integrity-hardening-design-plan.md), complete its resulting implementation plan, and only then begin the [reviewed migration waves](plans/2026-07-13-procedure-first-migration-waves-plan.md). Later routing remains [Stage 6 YAML retirement](plans/2026-07-07-yaml-retirement-program.md), [Stage 7 provider live binding](design/workflow_lisp_provider_live_binding.md), and [Stage 8 language server](design/workflow_lisp_language_server.md), in that order. The [Stage-0 activation plan](plans/2026-07-09-procedure-first-roadmap-activation-plan.md) owns activation evidence and plan-set tracking.

**Current procedure-first substrate:** The [accepted native-return and typed-guidance design](design/workflow_lisp_native_transportable_returns.md) is implemented through both reviewed Stage-5 return waves: [native transportable returns](plans/2026-07-10-workflow-lisp-native-transportable-returns-plan.md) and [typed result guidance](plans/2026-07-10-workflow-lisp-typed-result-guidance-plan.md). DSL v2.15 is supported by ordinary loaders. The older [field-guidance proposal](plans/2026-07-09-workflow-lisp-structured-result-field-guidance-plan.md) is superseded. The [resolved-effect substrate](plans/2026-07-13-procedure-first-substrate-gaps-plan.md) is also complete and gated. The accepted identity-compatibility contract is not yet implemented; follow the component-plan routing above.
