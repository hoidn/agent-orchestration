...
**Description:** Governing cross-plan work order for the completed refactor, migration, YAML-retirement, provider-live-binding, and list-traversal stages; it now routes the active final `.orc` language-server stage.
**Keywords:** workflow-lisp, roadmap, sequencing, parametric-types, procedure-first, refactoring, yaml-retirement
**Use this when:** Checking completed stage gates or selecting/auditing the active final language-server stage.
...
**Use this when:** Implementing or auditing the active final Stage 8 through the independently reviewed [nine-task implementation plan](plans/2026-07-25-workflow-lisp-language-server-implementation-plan.md).

### [Workflow Lisp Language Server Implementation Plan](plans/2026-07-25-workflow-lisp-language-server-implementation-plan.md)
**Description:** Active reviewed nine-task Stage-8 TDD selector for exact-byte source tracing, a read-only in-memory build seam, immutable single-root state, diagnostic parity, stdio/watcher transport, compiler-owned callee provenance, closed navigation, packaging, and end-to-end closure.
**Keywords:** lisp-frontend, lsp, implementation-plan, diagnostics, navigation, stage-8
**Use this when:** Executing or auditing the active final numbered roadmap stage.
...
**Use this when:** Auditing the completed 2026-07-07 program or tracing its prerequisite history. For sequencing, use the [Procedure-First Roadmap Execution Sequence](plans/2026-07-09-procedure-first-roadmap-execution-sequence.md); Stages 6-7 and the list-traversal interstage are complete, and Stage 8 is active. Do not restart Phase 1.
