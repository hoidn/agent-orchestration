...
**Description:** Active parallel substrate track. M0 is historical complete at `f15b888d`; M1 is historical complete at `57c2604e`, tree `fc0fdbef`, with its ordered reviews and postcommit selector closed. ML was selected at `e2e39422`; ML-1 is historical complete at `9c14dae3`, tree `0b149f96`; ML-2 is historical complete via its execution-record commit; and ML-4 is current.
**Keywords:** workflow-lisp, substrate, maintenance, persistence, roadmap, m0, m1, ml, at-least-once
**Use this when:** Selecting or auditing substrate work beside the Q/L roadmap. Execute current ML-4; ML-1 and ML-2 are historical complete. ML-3/provider-isolation and every security surface remain deferred; no Q5 or L-series gate is reopened or re-reviewed.
...
**Use this when:** Auditing the completed first ML runtime tranche. Preserve completed-result reuse and every source/checkpoint/integrity guard; do not touch provider isolation or security surfaces. ML-2 is historical complete and ML-4 is current.
...
**Use this when:** Auditing completed ML-2 after ML-1. Preserve ordinal uniqueness, legacy-state reads, atomic writes, and completed-result reuse; provider-isolation transfer machinery remains excluded. ML-4 is current.

### [Adjudication Rerun Recovery Component Plan](plans/2026-07-30-adjudication-rerun-recovery-component-plan.md)
**Description:** Current ML-4 reviewed plan replacing exact-scope adjudication resume mismatch failure with partial-visit cleanup, fresh ordinary dispatch, and `adjudication_state_mismatch_rerun`.
**Keywords:** provider, adjudication, resume, recovery, rerun, ml-4
**Use this when:** Implementing current ML-4 after historical-complete ML-2. Consistent completed visits still reuse; unknown, ambiguous, escaping, or aliased cleanup scope remains fail-closed.
