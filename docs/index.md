...
**Use this when:** Selecting or sequencing current post-Stage-8 work. Q5 Task 14 and the canonical transplant are complete; Q4's design amendment is accepted at `3c21ceb4`, and Q4 may enter implementation only after the Q5-era plan amendment receives ordered review and Task 0 closes. M1 remains outside Q4. L4 completion requires fresh ordered `L4_FINAL_SPEC_APPROVED` then `L4_FINAL_QUALITY_APPROVED` against the corrected committed tree. The final verdict is an external exact-tree record; no repository byte can self-attest its own post-commit review. Do not select E0, the parked evolution roadmap, shelved parsimony candidates, or P1–P5 from this route.
...
Q5-era Q4 design amendment is accepted at `3c21ceb4`; the plan amendment's
ordered reviews and Task 0 are the remaining implementation gates.
...
production and its frozen target-2.21 control. The design is not implemented
or available for authoring; execute only through the
[implementation plan](plans/2026-07-29-workflow-lisp-judgment-views-implementation-plan.md)
after its Q5-era plan amendment receives ordered review. The design amendment
is accepted at `3c21ceb4`; Q5 closure and the canonical transplant are
complete; M1 remains outside Q4.

### [Workflow Lisp Judgment Views Implementation Plan](plans/2026-07-29-workflow-lisp-judgment-views-implementation-plan.md)
**Description:** Q4 execution plan whose original pre-Q5 bytes were accepted at
`fbcba410`; the accepted design amendment is at `3c21ceb4`, and the current
Q5-era plan amendment requires fresh ordered review. It has one Task 0 entry
gate followed by nine implementation tasks for normative
...
**Use this when:** Executing Q4 after the Q5-era plan amendment receives
ordered `Q4_PLAN_SPEC_APPROVED` then `Q4_PLAN_QUALITY_APPROVED` and Task 0
closes. Q5 Task 14 and canonical transplant are complete; M1 remains outside
Q4.
...
amendment is accepted at `3c21ceb4`, while the plan amendment's ordered
reviews and Task 0 remain before Q4 implementation.
