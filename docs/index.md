...
**Component-plan routing:** [Executor decomposition](plans/2026-07-07-executor-decomposition.md), [lowering-fork migration](plans/2026-07-07-lowering-fork-migration.md), [typecheck-family completion](plans/2026-07-07-typecheck-family-completion.md), and [build-module split](plans/2026-07-07-build-module-split.md) are closed through their final verification gates. The [runtime union-field lineage plan](plans/2026-07-09-runtime-union-field-lineage-plan.md) and [boundary-report follow-ups](plans/2026-07-08-boundary-report-followups.md) are also complete. [Drain migration / G8 retirement](plans/2026-07-07-drain-migration-g8-retirement.md) Phase 1, Phase 2 Tasks 2.1–2.3, and Phase 3 Task 3.1 are complete; Gates P2 and P3 are independently reviewed and satisfied. The bounded [YAML-retirement](plans/2026-07-07-yaml-retirement-program.md) Task-5 family-1 promotion handoff is recorded through registration, strict parity, the `.orc` primary flip, and fresh end-to-end evidence without archive. **The current selector is drain Phase 3 Task 3.2: remove the `design_delta_parent_drain` parity target (promotion decision). Do not select Task 3.3+, Phase 4, typed result guidance, or YAML archive yet.** The [Stage-0 activation plan](plans/2026-07-09-procedure-first-roadmap-activation-plan.md) owns activation evidence and plan-set tracking.
