...
**Component-plan routing:** [Executor decomposition](plans/2026-07-07-executor-decomposition.md), [lowering-fork migration](plans/2026-07-07-lowering-fork-migration.md), [typecheck-family completion](plans/2026-07-07-typecheck-family-completion.md), and [build-module split](plans/2026-07-07-build-module-split.md) are closed through their final verification gates. The [runtime union-field lineage plan](plans/2026-07-09-runtime-union-field-lineage-plan.md), [boundary-report follow-ups](plans/2026-07-08-boundary-report-followups.md), and [Drain migration / G8 retirement](plans/2026-07-07-drain-migration-g8-retirement.md) are complete. Gates S3 and S4 are satisfied; Stage 4 closed with independent holistic specification and quality passes. **The current selector is [Stage 5 wave 2: typed result guidance](plans/2026-07-10-workflow-lisp-typed-result-guidance-plan.md).** It is followed in order by the [resolved-effect substrate](plans/2026-07-13-procedure-first-substrate-gaps-plan.md), [tracked-plan pilot](plans/2026-07-13-procedure-first-pilot-plan.md), and [reviewed migration waves](plans/2026-07-13-procedure-first-migration-waves-plan.md). Stage 6 YAML archive remains later. The [Stage-0 activation plan](plans/2026-07-09-procedure-first-roadmap-activation-plan.md) owns activation evidence and plan-set tracking.

**Current procedure-first substrate:** The [accepted native-return and typed-guidance design](design/workflow_lisp_native_transportable_returns.md) is scheduled in two reviewed Stage-5 waves. **Amendment (2026-07-10):** wave 1, [native transportable returns](plans/2026-07-10-workflow-lisp-native-transportable-returns-plan.md), executed ahead of Gates S3/S4 and is now landed compiler-internally; DSL v2.15 stays an unreleased private preview until the currently selected [typed result guidance](plans/2026-07-10-workflow-lisp-typed-result-guidance-plan.md) wave promotes it. The older [field-guidance proposal](plans/2026-07-09-workflow-lisp-structured-result-field-guidance-plan.md) is superseded.
