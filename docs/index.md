...
**Component-plan routing:** [Executor decomposition](plans/2026-07-07-executor-decomposition.md) is closed through its Task 9 verification gate. The active next plan is the [lowering-fork migration](plans/2026-07-07-lowering-fork-migration.md) closeout, followed by [typecheck-family completion](plans/2026-07-07-typecheck-family-completion.md), [build-module split](plans/2026-07-07-build-module-split.md), and [boundary-report follow-ups](plans/2026-07-08-boundary-report-followups.md). Then use the [drain migration / G8 retirement plan](plans/2026-07-07-drain-migration-g8-retirement.md) for the semantic migration. The [Stage-0 activation plan](plans/2026-07-09-procedure-first-roadmap-activation-plan.md) owns activation evidence and plan-set tracking.
