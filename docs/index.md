...
**Use this when:** Checking the E-series shape, gates, and sequencing prerequisites, or tracing the historical proposal. E0 is implemented pending final gate: Task 1 landed at `b71bf62a`, Task 2 at `3d41a8bf`, and Task 3 at `3b934373`; Task 4 routing and Task 5 final verification remain, so E0 is not complete. The canonical source is not copy-safe until `PASS_E0`, the accepted target-design examples remain non-copy-safe, and E1-E3 and C1-C3 remain Designed and unselected. E4P is exclusively absorbed by successor Stage Q3.
