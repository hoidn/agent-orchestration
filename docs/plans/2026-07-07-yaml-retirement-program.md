...
|---|---|---|
| 1 | `lisp_frontend_design_delta_drain.yaml` (+ 6 `v214` library imports) | Promotion handoff recorded, Gate P3 satisfied, Phase 3 Tasks 3.1–3.3 complete with the historical report preserved; `.orc` is primary, YAML/`v214` archive remains deferred to Stage 6, and the current selector is drain Phase 3 Task 3.4: Phase-3 verification. Task 3.4 has not started; Phase 4 and Stage 6 remain later work. |
