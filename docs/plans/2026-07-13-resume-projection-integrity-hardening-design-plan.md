...
- Task 1 characterization and feasibility evidence completed at `1cd60767`.
- Task 2 accepted target design and its design reviews completed at `52e2b05f`.
- Task 3 normative state/acceptance contract and its reviews completed at
  `00135832`.
- Task 4 detailed implementation plan and plan-document review completed at
  `26a5d3db`.
- Task 5 routing is complete: holistic specification and quality reviews
  passed; the routing module passed 22 tests; the focused characterization
  selector passed 36 tests; and the broad suite retained exactly the six
  established-unrelated baseline failures with 4764 passed and 13 skipped.
- The current executable selector is
  `docs/plans/2026-07-13-resume-projection-integrity-hardening-implementation-plan.md`.
  This ledger records completed design/specification/planning only; runtime
  hardening has not been implemented.
...
- [x] **Step 1: Record the clean task baseline and current call order**
...
- [x] **Step 2: Add a root/loop projection feasibility matrix**
...
- [x] **Step 3: Add current-callee and recursive-frame feasibility probes**
...
- [x] **Step 4: Characterize the mutation and observability envelope**
...
- [x] **Step 5: Run the feasibility selectors**
...
- [x] **Step 6: Review and commit characterization evidence only**
...
- [x] **Step 1: Compare insertion architectures from the measured order**
...
- [x] **Step 2: Write the target design from the repository template**
...
- [x] **Step 3: Include declarative positive and negative scenarios**
...
- [x] **Step 4: Obtain independent specification and architecture reviews**
...
- [x] **Step 5: Accept and commit the design only**
...
- [x] **Step 1: Add the normative state contract**
...
- [x] **Step 2: Add acceptance clauses and executable-proof routing**
...
- [x] **Step 3: Run a focused contract-drift sweep**
...
- [x] **Step 4: Obtain independent normative and quality reviews, then commit**
...
- [x] **Step 1: Invoke `superpowers:writing-plans` against the accepted authorities**
...
- [x] **Step 2: Preserve design decisions rather than reopening them**
...
- [x] **Step 3: Require TDD and end-to-end evidence**
...
- [x] **Step 4: Obtain independent plan-document review**
...
- [x] **Step 5: Commit the reviewed implementation plan only**
...
- [x] **Step 1: Add the explicit roadmap gate**
...
- [x] **Step 2: Update discoverability and status without claiming implementation**

Route the accepted design and both plans from `docs/index.md` and
`docs/design/README.md`. Add a capability-matrix row or update the closest row
to distinguish `designed/planned` from `implemented`. Do not put live selector
status into the durable design or normative state spec.

- [x] **Step 3: Obtain final holistic specification and quality reviews**
...
Expected: the focused suite and roadmap-routing module pass. The broad suite
either passes outright or retains exactly the six established-unrelated
baseline failure identities recorded by the governing
roadmap evidence, with no new failure identity or signature. Record fresh
command output; inspection alone is not completion evidence.

- [x] **Step 5: Commit the roadmap handoff and close this plan**
...
```bash
git diff --check -- docs/plans/2026-07-09-procedure-first-roadmap-execution-sequence.md docs/plans/2026-07-09-procedure-first-roadmap-activation-plan.md docs/plans/2026-07-13-procedure-first-migration-waves-plan.md docs/index.md docs/design/README.md docs/design/workflow_lisp_procedure_migration_identity_compatibility.md docs/capability_status_matrix.md docs/plans/2026-07-13-resume-projection-integrity-hardening-design-plan.md tests/test_workflow_lisp_drain_roadmap_routing.py
git add docs/plans/2026-07-09-procedure-first-roadmap-execution-sequence.md docs/plans/2026-07-09-procedure-first-roadmap-activation-plan.md docs/plans/2026-07-13-procedure-first-migration-waves-plan.md docs/index.md docs/design/README.md docs/design/workflow_lisp_procedure_migration_identity_compatibility.md docs/capability_status_matrix.md docs/plans/2026-07-13-resume-projection-integrity-hardening-design-plan.md tests/test_workflow_lisp_drain_roadmap_routing.py
