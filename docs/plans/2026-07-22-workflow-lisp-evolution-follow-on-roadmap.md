...
[plan review](../../artifacts/review/e2-trial-plan-review.md). Tasks 1–6 are
...
Task 7 bounded concurrent arm execution is selected; no E2 concurrent trial
execution producer exists yet. E3 remains selected pending the
