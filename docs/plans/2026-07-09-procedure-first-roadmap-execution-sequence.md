...
| `2026-07-22-workflow-lisp-evolution-follow-on-roadmap.md` | Incorporated as the tracked current E-series program by owner decision 2026-07-30. Its authoritative current mapping is E0 canonical direct control, E1 `run-ref`, E2 trials, and E3 external control; the old slimmed E0 probe remains unselected and, with the historical E0-E5 proposal, is superseded reference only. E0 is complete under `2026-07-31-workflow-lisp-e0-direct-control-component-plan.md` at `fe7d6f9b`, tree `c20f6fd9`, with `PASS_E0`. E1-E3 are owner-selected by `2026-07-31-workflow-lisp-e1-e3-owner-selection.md`. E1 is complete under the accepted target-2.24 `2026-07-31-workflow-lisp-e1-run-ref-component-plan.md`, `artifacts/review/e1-run-ref-plan-review.md`, and `artifacts/review/e1-run-ref-final-review.md`: `PASS_E1` at `577715f1`, tree `ef7eacbd`, after ordered final reviews and a fresh 864-pass postcommit control. The target-2.25 `2026-08-01-workflow-lisp-e2-trial-component-plan.md` is accepted at `c6046d38`, tree `40c533fc`, after ordered `E2_PLAN_SPEC_APPROVED` then `E2_PLAN_QUALITY_APPROVED`; see `artifacts/review/e2-trial-plan-review.md`. Tasks 0–9 are complete: Tasks 1–8 landed at `456acc7a`, `6b431087`, `43ae8d5c`, `ba430ed2`, `a7a8a083`, `5d28619d` (tree `44eb381b`), `41e64d14` (tree `fb6082d9`), and `ebf8a1a9` (tree `7f3a3b22`); Task 8 passed ordered `E2_TASK8_SPEC_APPROVED` then `E2_TASK8_QUALITY_APPROVED`. Task 9 implemented the public executor, SDK, and CLI through the ordinary compiler/runtime path across exact range `167b4a5d..3560b62edc623ebe15ca3c2b5c0e66eeb2f004aa`, final tree `f214f7627906e84782ad8ce04dc7c3bae51b276f`, cumulative diff SHA-256 `ebabf1870f8212e950f911a0487a06bfcc116c41a1aa0a411e435b809a0b8745`, and commits/trees `c69f05c9`/`d2fe944a`, `587ad8af`/`f944092e`, `e510844f`/`7f90defa`, `f8d7527e`/`04096b96`, `15609efc`/`1b253369`, and `3560b62e`/`f214f762`, after ordered `E2_TASK9_SPEC_APPROVED` then `E2_TASK9_QUALITY_APPROVED`. Its overlapping verification selectors passed 26 SDK, 487 integration, 55 observability, 208 final-slice, and 492 expanded combined tests. Task 10 and the canonical E2 exit are complete at `8aad035d`, tree `aafa31c`, after ordered `E2_FINAL_SPEC_APPROVED` then `E2_FINAL_QUALITY_APPROVED`. The exact slice collected and passed 51 tests, precommit and postcommit 77-module focused gates each passed 3,557, the real-subprocess smoke passed, the adjacent repair gate passed 249, the corrected broad non-security gate passed 11,403 with 19 skipped and 5 warnings, and the postcommit routing/readiness control passed 112. The fixed study proves the 1/2/2 DIRECT/COORDINATOR/ORC provider-call mechanism, identical controlled inputs, blinded ORC/DIRECT/COORDINATOR presentation, one-of-three classification, all 29 exclusion diagnostics, the zero-failure success table, and sibling-preserving deterministic COORDINATOR launch failure. It is mechanism proof only and makes no effectiveness, security, isolation, or sandbox claim. `artifacts/review/e2-trial-final-review.md` (`sha256:03ae6a57fb38f6d2d093004eac0ce851f256da8e19b0ff75d24f9859a5ee2d83`) records `PASS_E2` within the exact target-2.25 contract. No production `.orc` registry row was added and route-readiness remains unchanged. ES is the on-spine plan- and review-gated stage. Its component plan is accepted; Tasks 0–5 are complete. Task 1's history-free projection closed at `62a5c72d`, tree `5eb5ca32`, after ordered `ES_TASK1_SPEC_APPROVED` then `ES_TASK1_QUALITY_APPROVED`; see `artifacts/review/es-first-effectiveness-study-task1-review.md`. Task 2's provider-free task/evaluator package closed at `d24c1818`, tree `5e8f84cb`, after ordered `ES_TASK2_SPEC_APPROVED` then `ES_TASK2_QUALITY_APPROVED`; see `artifacts/review/es-first-effectiveness-study-task2-review.md`. Task 3's exact metering and decision-lock validation closed at `0d16ca36`, tree `ee6d60eb`, after ordered `ES_TASK3_SPEC_APPROVED` then `ES_TASK3_QUALITY_APPROVED`; see `artifacts/review/es-first-effectiveness-study-task3-review.md`. Task 4's four provider-free QA-placement treatment workflows closed at `d72c6085`, tree `4e576d09`, after ordered `ES_TASK4_SPEC_APPROVED` then `ES_TASK4_QUALITY_APPROVED`; see `artifacts/review/es-first-effectiveness-study-task4-review.md`. Task 5's provider-free controller closed at `e5ec552d`, tree `1b0f0e67`, after ordered `ES_TASK5_SPEC_APPROVED` then `ES_TASK5_QUALITY_APPROVED`; see `artifacts/review/es-first-effectiveness-study-task5-review.md`. The owner-directed large-scope F1 refreeze is next and must land before Task 6 can freeze an adoptable package; live allocation remains prohibited. Phase ME is parallel and nonblocking. E3 remains gated on fixed-study review, ES results, and a separate reviewed component plan. C1-C3, E2O, the historical registry substrate, and security work remain unselected. E4P remains exclusively absorbed by successor Stage Q3. |
