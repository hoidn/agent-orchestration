...
| `2026-07-22-workflow-lisp-evolution-follow-on-roadmap.md` | Incorporated as the tracked current E-series program by owner decision 2026-07-30. Its authoritative current mapping is E0 canonical direct control, E1 `run-ref`, E2 trials, and E3 external control; the old slimmed E0 probe remains unselected and, with the historical E0-E5 proposal, is superseded reference only. E0 is complete under `2026-07-31-workflow-lisp-e0-direct-control-component-plan.md` at `fe7d6f9b`, tree `c20f6fd9`, with `PASS_E0`. E1-E3 are owner-selected by `2026-07-31-workflow-lisp-e1-e3-owner-selection.md`. E1 Tasks 0–8 are complete under the accepted target-2.24 `2026-07-31-workflow-lisp-e1-run-ref-component-plan.md` and `artifacts/review/e1-run-ref-plan-review.md`; the end-to-end proof landed at `2a1f42f2` and closed at `79540e0a` after ordered Task-8 reviews. `run-ref` is implemented pending Task 9's focused, broad non-security, final-review, and canonical-exit gates, so no `PASS_E1` is recorded yet. E2 remains selected pending `PASS_E1`; E3 remains selected pending `PASS_E2` and review of the first fixed study. C1-C3 remain Designed and unselected. E4P remains exclusively absorbed by successor Stage Q3. |
