...
| `2026-07-22-workflow-lisp-evolution-follow-on-roadmap.md` | Incorporated as the tracked current E-series program by owner decision 2026-07-30. Its authoritative current mapping is E0 canonical direct control, E1 `run-ref`, E2 trials, and E3 external control; the old slimmed E0 probe remains unselected and, with the historical E0-E5 proposal, is superseded reference only. The accepted E0/C1 designs, completed lean-pilot owner handoff, and ordered plan reviews selected only E0 under `2026-07-31-workflow-lisp-e0-direct-control-component-plan.md`. Tasks 1–4 landed at `b71bf62a`, `3d41a8bf`, `3b934373`, and `46387582`. E0 is complete at `fe7d6f9b`, tree `c20f6fd9`, with `PASS_E0` after ordered `E0_FINAL_SPEC_APPROVED` then `E0_FINAL_QUALITY_APPROVED`; its postcommit direct-control/routing/route-readiness control passed 115 tests. E1-E3 are owner-selected by the durable `2026-07-31-workflow-lisp-e1-e3-owner-selection.md` record. The E1 component plan is accepted for execution at target 2.24 under `2026-07-31-workflow-lisp-e1-run-ref-component-plan.md` and `artifacts/review/e1-run-ref-plan-review.md`, with Task 1 active; E2 and E3 remain prerequisite-gated. C1-C3 remain Designed and unselected. E4P remains exclusively absorbed by successor Stage Q3. |
