...
> Task 2.2 after reviewed Task 2.1 completion. Execute drain Phase 2+ before the later Stage-5 typed-result-guidance
...
`docs/plans/2026-07-07-drain-migration-g8-retirement.md` Phase 2 Task 2.2, as
