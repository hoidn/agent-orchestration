...
8. Audit negative-path coverage against the case list below; wire or recreate
   ...
   **Audit result (2026-07-08):**
   ...
   | 5. Runtime output failure attribution to an authored union field | **Implementation gap confirmed** | The Task 5 feasibility reproduction confirmed that the current runtime/source-map substrate cannot support the required attribution test without production changes. See `docs/plans/2026-07-08-boundary-report-followups.md` Task 5 case 5 for the design gate and current ownership. |
