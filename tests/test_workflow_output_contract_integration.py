...
# bundle-overrides-exit contract retired (contradicted by specs/io.md:44-48); current behavior owned by test_nonzero_exit_skips_output_bundle_validation below.
