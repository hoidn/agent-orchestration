...
def test_dsl_follow_on_plan_impl_review_loop_v2_call_runtime(tmp_path: Path):
    ...
    for repo_file in [
        ...
        "workflows/library/prompts/dsl_follow_on_plan_impl_loop_v2_call/draft_plan.md",
        "workflows/library/prompts/dsl_follow_on_plan_impl_loop_v2_call/review_plan.md",
        "workflows/library/prompts/dsl_follow_on_plan_impl_loop_v2_call/revise_plan.md",
        "workflows/library/prompts/dsl_follow_on_plan_impl_loop_v2_call/implement_plan.md",
        "workflows/library/prompts/dsl_follow_on_plan_impl_loop_v2_call/review_implementation.md",
        "workflows/library/prompts/dsl_follow_on_plan_impl_loop_v2_call/fix_implementation.md",
        "workflows/examples/inputs/dsl-follow-on-upstream-completed-state.json",
        "docs/plans/2026-03-06-dsl-evolution-control-flow-and-reuse.md",
    ]:
...
def test_backlog_priority_design_plan_impl_stack_v2_call_runtime(tmp_path: Path):
    ...
    for repo_file in [
        ...
        "workflows/library/prompts/design_plan_impl_stack_v2_call/draft_design.md",
        "workflows/library/prompts/design_plan_impl_stack_v2_call/review_design.md",
        "workflows/library/prompts/design_plan_impl_stack_v2_call/revise_design.md",
        ...
        "workflows/library/prompts/design_plan_impl_stack_v2_call/revise_plan.md",
