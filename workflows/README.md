...
| `workflows/library/lisp_frontend_selector.v214.yaml` | `2.14` | `lisp-frontend-selector-v214` | Lisp frontend selector subworkflow: consumes steering, full/MVP design specs, backlog manifest, progress ledger, and run state, then emits `SELECT_BACKLOG_ITEM`, `DRAFT_DESIGN_GAP`, `DONE`, or `BLOCKED`. |
...
| `workflows/library/lisp_frontend_design_gap_architect.v214.yaml` | `2.14` | `lisp-frontend-design-gap-architect-v214` | Drafts and validates an implementation architecture/work-item bundle for a selector-chosen Lisp frontend design gap. |
...
| `workflows/library/lisp_frontend_work_item.v214.yaml` | `2.14` | `lisp-frontend-work-item-v214` | Normalizes backlog-selected and design-gap-selected Lisp frontend work into one plan phase plus implementation phase and records completed or blocked work in the Lisp drain run state. |
...
| `workflows/library/lisp_frontend_plan_phase.v214.yaml` | `2.14` | `lisp-frontend-plan-phase-v214` | Lisp frontend planning phase: materializes steering/design/work-item context, drafts the execution plan, and records a structured plan review decision. |
...
| `workflows/library/lisp_frontend_implementation_phase.v214.yaml` | `2.14` | `lisp-frontend-implementation-phase-v214` | Lisp frontend implementation phase: executes an approved plan, validates the provider-emitted implementation variant bundle, runs check commands, and records implementation review output. |
