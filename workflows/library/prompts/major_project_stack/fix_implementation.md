...
For nontrivial failures or repeated review findings, diagnose the failure systematically before changing code: reproduce it, locate the faulty component, and fix the root cause, not the symptom.
