...
- diagnose the root cause of any nontrivial runtime failures systematically: reproduce the failure, locate the faulty component, and identify the root cause rather than the symptom
