...
STDLIB_LOWERING_CONTRACTS: tuple[StdlibLoweringContract, ...] = (
    ...
    StdlibLoweringContract(
        ...
        backend_kinds=("certified_adapter", "runtime_native"),
        required_statement_families=("output_bundle",),
        alternative_statement_family_sets=(("command_step", "resource_transition"),),
        delegated_statement_family_policy="none",
        state_root_policies=("generated_hidden_bundle_input",),
        authority_model="validated_structured_result_bundle",
        proof_model="contract_validated_bundle",
    ...
    StdlibLoweringContract(
        ...
        family="resource_finalize_drain",
        backend_kinds=("runtime_native",),
        required_statement_families=("match", "materialize_view", "output_bundle"),
        alternative_statement_family_sets=(),
        delegated_statement_family_policy="none",
        state_root_policies=("generated_hidden_bundle_input", "runtime_native_resource_state"),
        authority_model="transition_audit_backed_materialized_summary",
        proof_model="typed_transition_then_branch_normalization",
        source_map_expectations=(
            "high_level_form_origin",
            "generated_step_span",
            "generated_hidden_input_span",
    ...
    StdlibLoweringContract(
        ...
        authority_model="typed_terminal_transition_and_materialized_summary",
        proof_model="dedicated_runtime_proof_with_typed_terminal_parity",
        source_map_expectations=(
            "high_level_form_origin",
            "generated_step_span",
            "generated_hidden_input_span",
