...
_FORM_SPECS = (
    ...
    *(
    ...
    _spec(
        ...
        kind=FormKind.CORE_EFFECT,
        owner_module="expressions",
        introduced_in="workflow_lisp_trial_runs_e1",
        remove_by=None,
        macro_bindable=False,
        admitted_top_level=False,
        elaboration_route="run_ref",
        feature_tags=("workspace_pinned_child_run",),
        rationale="Pinned child-run effects elaborate through one closed compiler path.",
        min_target_dsl_version="2.24",
    ),
    _spec(
        "trial",
        kind=FormKind.CORE_EFFECT,
        owner_module="expressions",
        introduced_in="workflow_lisp_trial_runs_e2",
        remove_by=None,
        macro_bindable=False,
        admitted_top_level=False,
        elaboration_route="trial",
        feature_tags=("bounded_static_trial",),
        rationale="Bounded static trials elaborate through one closed compiler path.",
        min_target_dsl_version="2.25",
    ),
    _spec(
        "review-revise-loop",
    ...
    _spec(
        ...
        rationale="Imported std/phase macros currently lower through one private compiler-owned phase wrapper.",
    ),
    _spec(
        "with-phase",
        kind=FormKind.TEMP_COMPILER_INTRINSIC,
        ...
        rationale="The public std/phase wrapper remains directly elaborated until ordinary stdlib phase composition owns it.",
    ),
    _spec(
        "phase-target",
        kind=FormKind.TEMP_COMPILER_INTRINSIC,
    ...
    _spec(
        ...
        kind=FormKind.TEMP_COMPILER_INTRINSIC,
        owner_module="stdlib_modules/std/resource.orc",
        introduced_in="workflow_lisp_generic_resource_context_core",
        remove_by="ordinary imported stdlib expansion",
        macro_bindable=True,
        admitted_top_level=False,
        elaboration_route="finalize_selected_item",
        feature_tags=("compatibility_route_only",),
        rationale="Selected-item fan-in remains a compatibility intrinsic while the imported stdlib route is converging.",
    ),
    _spec(
        "backlog-drain",
        kind=FormKind.STDLIB_EXTENSION,
        ...
        admitted_top_level=False,
        elaboration_route=None,
        rationale="The public stdlib backlog drain stays macro-bindable and reaches the compiler via imported stdlib expansion.",
    ),
    _spec(
        "materialize-view",
        kind=FormKind.TEMP_COMPILER_INTRINSIC,
