"""Temporary G8 deletion-evidence plumbing retained pending Task 4.2 removal.
...
pending removal by Task 4.2; migration parity no longer consumes that artifact.
"""
